...
const CATEGORY_KEYWORDS = Object.freeze({
  [EXPENSE_CATEGORIES.FOOD]: [
    '餐', '飯', '早餐', '午餐', '晚餐', '宵夜', '咖啡', '飲料', '拉麵', '壽司', '燒肉', '便當', '甜點', '麵包', '六花亭', '茶', '玉米',
    'food', 'restaurant', 'cafe', 'coffee', 'breakfast', 'lunch', 'dinner', 'ramen', 'sushi', 'meal', 'cranberry', 'tea',
    'レストラン', 'カフェ', 'コーヒー', '朝食', '昼食', '夕食', 'ラーメン', '寿司', '食事', '菓子', 'ケーキ', 'スイーツ', 'アイス', 'パイ', 'クランベリー', 'ポテト', 'お茶', 'とうきび', 'とうきび茶',
  ],
